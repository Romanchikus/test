...
while True: # ждём первую строку
    dud=input()
    dud = '/?task=' + dud
    duda = dud + '&amp; users=[{“id”:“1",“firstName”:“John”,“lastName”:“Smith”},{“id”:“4",“firstName”:“Ольга“,”lastName”:“Пылева“},{“id”:“10",“firstName”:“Тарас“,”lastName”:“Сагайдачний“},{“id”:“12",“firstName”:“Влад“,”lastName”:“Сидорчук“}]&amp; apiKey=AIzaSyDa-3reugkWAvksex60RKzTGkk80AXqolI&amp; languageCode=ru HTTP/1.1'
    dud=urllib.parse.quote(duda)
